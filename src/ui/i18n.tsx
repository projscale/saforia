...
const bundle: Bundle = {
  en: {
    ...
    aboutBackupExport: 'Export encrypted backup to a .safe file (optional passphrase).',
    aboutBackupImport: 'Import from a .safe file; choose overwrite to replace existing entries.',
    aboutCsvTitle: 'CSV import/export',
    aboutCsvNotes: 'Use CSV for migration. You will map imported fingerprints to your local Masters.',
  ...
  ru: {
    ...
    aboutBackupExport: 'Экспорт зашифрованного бэкапа в .safe (по желанию — с паролем).',
    aboutBackupImport: 'Импорт из .safe; опция «перезаписать» заменит существующие записи.',
    aboutCsvTitle: 'CSV импорт/экспорт',
    aboutCsvNotes: 'Для миграции используйте CSV. На шаге импорта сопоставьте отпечатки к локальным Мастерам.',
