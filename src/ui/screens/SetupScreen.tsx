  ...
  return (
    <div className="card" style={{ marginBottom: 16 }}>
      ...
      <form onSubmit={(e) => { e.preventDefault(); if (valid && !busy) onSubmit() }} className="col">
        ...
        <PasswordInput label="Viewer password (used to encrypt master)" value={state.viewer} onChange={v => setState({ ...state, viewer: v })} placeholder="Device-only viewer" autoComplete="new-password" />
